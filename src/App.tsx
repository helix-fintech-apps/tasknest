    ...
    <div className="min-h-screen">
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-6xl items-center gap-4 px-4 py-3">
          ...
          >
            <span className="inline-block h-7 w-7 rounded-lg bg-blue-600 text-center text-white">
              ⌂
            </span>{" "}
            TaskNest
          </NavLink>
          <nav className="flex flex-1 flex-wrap items-center gap-1" data-testid="main-nav">
            ...
            <NavLink to="/pricing" className={linkCls} data-testid="nav-pricing">
              Pricing & policies
            </NavLink>
          </nav>
          {session ? (
    ...
    <Shell>
      <Routes>
        ...
        <Route
          path="/taskers"
          element={
            <RequireRole roles={["client", "admin", "support_agent"]}>
              <Taskers />
            </RequireRole>
          }
        />
        ...
        <Route
          path="/console"
          element={
            <RequireRole roles={["admin", "support_agent"]}>
              <Console />
            </RequireRole>
          }
        />
