...
export const dr = (account: Account, amount: number, party?: string, unit: Unit = "USD"): Line => ({
  account,
  party,
  unit,
  debit: amount,
...
export const cr = (account: Account, amount: number, party?: string, unit: Unit = "USD"): Line => ({
  account,
  party,
  unit,
  debit: 0,
